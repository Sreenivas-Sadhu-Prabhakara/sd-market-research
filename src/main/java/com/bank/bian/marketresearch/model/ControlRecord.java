package com.bank.bian.marketresearch.model;
...
/**
 * The BIAN control record for this service domain: "Market Research Study Analysis".
 *
 ...
 * to its asset type (Market Research Study). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Research Study Analysis";
